...
int main(int argc, char * argv[]) {
	...
	ImageIO::debugFolder = "C:\\ti-software\\HU-Vision-1819-Dylan-Joost\\test";
	...
	if (!ImageIO::loadImage("C:\\ti-software\\HU-Vision-1819-Dylan-Joost\\testsets\\Set A\\TestSet Images\\female-3.png", *input)) {
